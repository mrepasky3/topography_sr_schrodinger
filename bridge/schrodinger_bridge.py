# ---------------------------------------------------------------
# Adapted from I2SB repository: https://github.com/NVlabs/I2SB
#
# Guan-Horng Liu, et al. "I2SB: image-to-image Schrödinger bridge." 
...
class Diffusion():
    ...
    def ddpm_sampling(self, imgs, masks, steps, pred_x0_fn, x1, log_steps=None, verbose=True, ot_ode=False):
        ...
        for prev_step, step in pair_steps:
            ...
            pred_x0 = pred_x0_fn(xt, imgs, masks, step)
...
def compute_pred_x0(diffusion, step, xt, net_out):
